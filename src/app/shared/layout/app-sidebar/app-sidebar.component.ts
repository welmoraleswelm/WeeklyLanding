...
export class AppSidebarComponent {
  private readonly exactPathMatchOptions: IsActiveMatchOptions = {
    paths: 'exact',
    queryParams: 'ignored',
  ...
  navItems: NavItem[] = [
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M5.5 3.25C4.25736 3.25 3.25 4.25736 3.25 5.5V8.99998C3.25 10.2426 4.25736 11.25 5.5 11.25H9C10.2426 11.25 11.25 10.2426 11.25 8.99998V5.5C11.25 4.25736 10.2426 3.25 9 3.25H5.5ZM4.75 5.5C4.75 5.08579 5.08579 4.75 5.5 4.75H9C9.41421 4.75 9.75 5.08579 9.75 5.5V8.99998C9.75 9.41419 9.41421 9.74998 9 9.74998H5.5C5.08579 9.74998 4.75 9.41419 4.75 8.99998V5.5ZM5.5 12.75C4.25736 12.75 3.25 13.7574 3.25 15V18.5C3.25 19.7426 4.25736 20.75 5.5 20.75H9C10.2426 20.75 11.25 19.7427 11.25 18.5V15C11.25 13.7574 10.2426 12.75 9 12.75H5.5ZM4.75 15C4.75 14.5858 5.08579 14.25 5.5 14.25H9C9.41421 14.25 9.75 14.5858 9.75 15V18.5C9.75 18.9142 9.41421 19.25 9 19.25H5.5C5.08579 19.25 4.75 18.9142 4.75 18.5V15ZM12.75 5.5C12.75 4.25736 13.7574 3.25 15 3.25H18.5C19.7426 3.25 20.75 4.75736 20.75 6V9V19C20.75 20.2426 19.7426 21.25 18.5 21.25H15C13.7574 21.25 12.75 20.2426 12.75 19V15C12.75 13.7574 13.7574 12.75 15 12.75H18.5C18.9142 12.75 19.25 12.4142 19.25 12V6C19.25 5.58579 18.9142 5.25 18.5 5.25H15C14.5858 5.25 14.25 5.58579 14.25 6V8.99998C14.25 9.41419 14.5858 9.74998 15 9.74998H18.5C18.9142 9.74998 19.25 9.41419 19.25 8.99998V8.25H20.75V8.99998C20.75 10.2426 19.7426 11.25 18.5 11.25H15C13.7574 11.25 12.75 10.2426 12.75 8.99998V5.5Z" fill="currentColor"></path></svg>`,
      name: 'Dashboard',
      path: '/dashboard',
    },
    {
    ...
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15.5 7C15.5 8.933 13.933 10.5 12 10.5C10.067 10.5 8.5 8.933 8.5 7C8.5 5.067 10.067 3.5 12 3.5C13.933 3.5 15.5 5.067 15.5 7Z" stroke="currentColor" stroke-width="1.5"/><path d="M4.75 18.5C4.75 15.0482 7.54822 12.25 11 12.25H13C16.4518 12.25 19.25 15.0482 19.25 18.5V19.25H4.75V18.5Z" stroke="currentColor" stroke-width="1.5"/><path d="M18.5 10.25H21.25M19.875 8.875V11.625" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>`,
      name: 'Gestión contribuyentes',
  ...
  isActive(path: string): boolean {
    return this.router.isActive(path, this.exactPathMatchOptions);
  }

  isSectionActive(path: string): boolean {
    const activePath = this.getActivePrimaryPath();
    return activePath === path || activePath.startsWith(`${path}/`);
  }

  private getActivePrimaryPath(): string {
    const tree = this.router.parseUrl(this.router.url);
    const primarySegments = tree.root.children['primary']?.segments ?? [];
    return `/${primarySegments.map((segment) => segment.path).join('/')}`;
  }
